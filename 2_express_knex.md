...
Then, play around with the live application by viewing and editing books. As you play, take a peek at the code for the client application and familiarize yourself with the following techniques.
